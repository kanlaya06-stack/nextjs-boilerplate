...
import { 
  Store, Search, Tag, PlusCircle, X, Check, ShieldCheck, 
  Sparkles, Filter, ShoppingBag, ArrowRight
} from 'lucide-react';
import Link from 'next/link';

// Mock Data สินค้าตัวอย่างในวิทยาลัย
...
// 3D Preview Item Component
function Product3DModel({ color }: { color: string }) {
              ...
              >
                ...
                <div className="h-48 bg-slate-50 relative flex items-center justify-center border-b border-slate-100">
                  ...
                  <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
                    <Product3DModel color={item.color} />
                  </Canvas>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                {/* 3D Box Modal */}
                <div className="h-64 md:h-full bg-slate-50 flex items-center justify-center relative border-b md:border-b-0 md:border-r border-slate-100 min-h-[260px]">
                  <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
                    <Product3DModel color={activeProduct.color} />
                  </Canvas>
