    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 font-sans flex flex-col justify-between">
      <header className="max-w-7xl mx-auto w-full px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-2.5 px-4 py-2 rounded-2xl bg-white border border-slate-200/80 shadow-sm">
          ...
          <span className="font-extrabold text-slate-900 text-sm">College Market 3D</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-slate-500 text-base sm:text-lg max-w-xl">
              ส่งต่ออุปกรณ์การเรียน เสื้อผ้า และไอเทมมือสองภายในวิทยาลัยได้อย่างมั่นใจ สัมผัสประสบการณ์หมุนดู 3D ในรูปแบบมินิมอล
            </p>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="w-full max-w-[420px] aspect-square bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 rounded-[36px] p-6 shadow-2xl shadow-blue-500/30 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="z-10 text-center space-y-1">
                <h3 className="text-white font-bold text-xl">College Market 3D</h3>
                <p className="text-blue-100 text-xs">ระบบซื้อขายแลกเปลี่ยนมือสองสำหรับนักศึกษา</p>
              </div>
            </div>
          </div>
        </div>
